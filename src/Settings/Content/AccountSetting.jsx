  ...
  return (
    ...
    <div className='ml-[18%] mt-[25px] w-[70%]'>
        <div className='pb-[35px] border-b-2 border-solid'>
            ...
            <p className='text-center text-[12px] pt-[10px]'>Upload your <br /> photo</p>
            </div>
        </div>
        <div className='grid grid-cols-2 gap-[30px] my-[30px]'>
            <div>
                <label className='text-white'>First Name</label>
                <input type="text" className='w-[100%] h-[52px] rounded-[8px] mt-[10px]'/>
            </div>
            <div>
            ...
            <div>
                ...
                <select name="occupation" className='w-[100%] h-[52px] rounded-[8px] mt-[10px]'>
                    <option value="#"></option>
