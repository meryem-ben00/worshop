              ...
              <tr className="text-[#FFFFFF]">
                <td className="py-4 flex items-center  ">
                  ...
                  <div className="flex flex-col items-start">
                    <h2>{item.name}</h2>
                    <p className="text-[#B5B5C3]">{item.disease}</p>
                  </div>
                </td>
                ...
                <td className="py-4">
                  <span
                    className={`inline-block mx-auto  flex items-center 'text-[#5F8D4E] justify-center bg-[#F4FFF3]' text-[11px] font-medium	 rounded-md w-[74px] h-[26px] ${
                      item.status === "declined"
                        ? "bg-[#FFE2E5] text-[#F64E60]"
                        : "text-[#5F8D4E]  bg-[#F4FFF3]"
                    }`}
                  >
                    {item.status}
                  </span>
                ...
                <td className="py-4">
                  <button className="bg-[#FAFAFA] inline-flex p-2 rounded-md text-gray-700">
