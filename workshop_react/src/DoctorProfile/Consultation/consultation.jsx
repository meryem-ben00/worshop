...
const Consultation = () => {
    ...
    return (
        <Card colSpanStyle="col-span-2 h-[309px] p-[19px]">
            ...
            <div className="h-[219px] flex flex-row border-[1px] border-opacity-50 border-blue-500 rounded-md">
                <div className="p-[20px] border-r-[1px] border-opacity-50 border-blue-500 w-[400px] flex justify-center content-center flex-col gap-[10px]">
